...
public class M11 extends SpaceShip {

    char[] controlKeys;

    public M11(char[] controlKeys) {
        super();
    ...
    private Part[] createBody(float x, float y, float heading) {
        ...
        parts[25] = new ReverseRocket(bd1, controlKeys[0]);

        BodyDef bd2 = new BodyDef();
        bd2.position.set(x - 2.5F, y + 10F);
        parts[26] = new ReverseRocket(bd2, controlKeys[1]);

        BodyDef bd3 = new BodyDef();
        bd3.position.set(x - 2.5F, y);
        parts[27] = new ReverseRocket(bd3, controlKeys[2]);
